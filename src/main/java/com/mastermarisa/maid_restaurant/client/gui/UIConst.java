...
import com.mastermarisa.maid_restaurant.client.gui.base.ImageData;
...
public interface UIConst {
    ...
    ImageData cycle_powered = new ImageData(MaidRestaurant.resourceLocation("textures/gui/cycle_powered.png"),new Rectangle(0,0,14,16),14,16,14,16);
    ImageData cycle_unpowered = new ImageData(MaidRestaurant.resourceLocation("textures/gui/cycle_unpowered.png"),new Rectangle(0,0,14,16),14,16,14,16);
    ImageData cross = new ImageData(MaidRestaurant.resourceLocation("textures/gui/cross_1.png"),new Rectangle(0,0,8,8),8,8,8,8);
    ImageData cross_1 = new ImageData(MaidRestaurant.resourceLocation("textures/gui/cross.png"),new Rectangle(0,0,7,7),7,7,7,7);
