...
public class MaidGatherMaterialTask extends MaidCheckRateTask {
    ...
    protected boolean checkExtraStartConditions(ServerLevel level, EntityMaid maid) {
        ...
        ExecutionNode node = ChefScheduler.findNeedMaterialNode(level, maid);
    ...
    private boolean searchStorage(ServerLevel level, EntityMaid maid, ExecutionNode node) {
        ...
        ChefScheduler.reclaimRequest(level, maid);
        CheckRateHelper.setRemainingTicks(maid.getUUID(), UID, maxInterval * 2);
        return false;
    }
