...
public class SitEntity extends Entity {
    public static final EntityType<SitEntity> TYPE;
    ...
    static {
        TYPE = EntityType.Builder.<SitEntity>of(SitEntity::new, MobCategory.MISC).sized(0.5F, 0.1F).clientTrackingRange(10).fireImmune().noSummon()
                .build(MaidRestaurant.resourceLocation("sit_entity").toString());
    }
}
